    ...
    while(headless || window.isOpen())
    {
        ...
        //{
            ...
            while(window.pollEvent(event))
            {
                ...
                {
                    if(check_classification(event.key.code))
                        terminate = true;
                }
            }
        //}
...
int main(int num_args, char** args)
{
    ...
    //
    //
    //std::vector<int> k_sweep{1, 5, 9};
    //std::vector<int> i_sweep{1, 5, 9};
    //std::vector<int> d_sweep{1, 5, 9};
    //std::vector<float> m_sweep{0.0, 0.1, 0.2};
    //std::vector<float> epk_sweep{0.0, 0.25, 0.5};
    //std::vector<float> epi_sweep{0.0, 0.25, 0.5};
    //std::vector<int> version{0,1,2};
